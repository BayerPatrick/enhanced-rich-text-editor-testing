...
@Route(value = "rich_text_editors", layout = MainView.class)
public class RichTextEditorsView extends VerticalLayout {

    public static final String TITLE = "Rich Text Editors";
